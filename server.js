  ...
  if (s === 'pin') {
    ...
    html = \`
      <div class="screen active">
        ...
        <div class="glass" style="margin-top:16px">
          <div><label><input type="radio" name="autoLock" value="0"> Off</label></div>
          <div><label><input type="radio" name="autoLock" value="1"> 1 Minute</label></div>
          <div><label><input type="radio" name="autoLock" value="5" checked> 5 Minutes</label></div>
          <div><label><input type="radio" name="autoLock" value="15"> 15 Minutes</label></div>
          <div><label><input type="radio" name="autoLock" value="30"> 30 Minutes</label></div>
